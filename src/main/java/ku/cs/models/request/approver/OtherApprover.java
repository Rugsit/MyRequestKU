...
public class OtherApprover extends Approver{
    ...
    public OtherApprover(String requestUUID, String tier, String associateUUID, String role, String firstname, String lastname) throws ApproverException {
        super(requestUUID, tier, associateUUID, role, firstname, lastname);
    }

    public OtherApprover(String tier, String associateUUID, String role, String firstname, String lastname) throws ApproverException {
        super(tier, associateUUID, role, firstname, lastname);
    }

    public OtherApprover(String uuid, String requestUUID, String tier, String associateUUID, String role, String status, String signatureFile, String firstname, String lastname) throws ApproverException {
