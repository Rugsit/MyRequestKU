...
public class Ku1FormController {
    ...
    private Ku1AndKu3RequestForm createKu1Form() {
        ...
        return new Ku1AndKu3RequestForm(uuid,loginUser.getUUID(), loginUser.getName(), loginUser.getId(), now, now, "KU1", "ใบคำร้องใหม่", "ส่งคำร้องต่อให้อาจารย์ที่ปรึกษา", "none");
    }
