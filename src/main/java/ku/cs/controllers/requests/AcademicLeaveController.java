...
public class AcademicLeaveController {
    ...
    private AcademicLeaveRequestForm createAcademicLeaveRequestForm() {
        ...
        return new AcademicLeaveRequestForm(uuid,loginUser.getUUID(), loginUser.getName(), loginUser.getId(), now, now, "AcademicLeave", "ใบคำร้องใหม่", "ส่งคำร้องต่อให้อาจารย์ที่ปรึกษา", "none");
    }
