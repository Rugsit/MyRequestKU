...
public class Ku3FormController {
    ...
    private Ku1AndKu3RequestForm createKu3Form() {
        ...
        return new Ku1AndKu3RequestForm(uuid,loginUser.getUUID(), loginUser.getName(), loginUser.getId(), now, now, "KU3", "ใบคำร้องใหม่", "ส่งคำร้องต่อให้อาจารย์ที่ปรึกษา", "none");
    }
