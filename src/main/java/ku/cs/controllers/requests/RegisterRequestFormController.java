...
public class RegisterRequestFormController {
    ...
    private RegisterRequestForm createRegisterForm() {
        ...
        return new RegisterRequestForm(uuid,loginUser.getUUID(), loginUser.getName(), loginUser.getId(), now, now, "Register", "ใบคำร้องใหม่", "ส่งคำร้องต่อให้อาจารย์ที่ปรึกษา", "none");
    }
