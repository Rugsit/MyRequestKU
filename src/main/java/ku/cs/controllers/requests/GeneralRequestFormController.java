...
public class GeneralRequestFormController {
    ...
    private GeneralRequestForm createGeneralForm() {
        ...
        return new GeneralRequestForm(uuid,loginUser.getUUID(), loginUser.getName(), loginUser.getId(), now, now, "General", "ใบคำร้องใหม่", "คำร้องส่งต่อให้อาจารย์ที่ปรึกษา", "none");
    }
