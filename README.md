...
1. ทำการโหลด jar file ที่ตรงกับระบบปฏิบัติการของคุณ
2. นำ jar file และโฟลเดอร์ data มาอยู่ที่เดียวกัน
3. สามารถคลิกที่ jar file เพื่อเปิดโปรแกรมได้เลย หรือใช้คำสั่ง java -jar ชื่อไฟล์.jar
        ...
        └── resources
            ...
            └── ku
                └── cs
                    ...
                    │   │       ├── nisit-management (เป็นโฟลเดอร์ที่เก็บไฟล์ css ที่เกี่ยวข้องกับภาควิชาในหน้าจัดการอาจารย์นิสิต)
